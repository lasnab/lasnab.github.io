...
const navbar = {
  ...
  links: [
    ...
    },
    {
      link_name: 'Resume',
      external_link_path:
        'https://drive.google.com/file/d/1Up6DxqgfG-k5yL_Yv1dOfJQtDIkpy2R4/view',
    },
  ],
};
...
const softwares = [
  ...
  },
  {
    name: 'Helping Hand',
    image:
      'https://raw.githubusercontent.com/lasnab/helping-hand/master/logo.png',
    links: [
      {
        name: 'GitHub',
  ...
  },
  {
    name: 'Email Lister',
    image:
      'https://raw.githubusercontent.com/lasnab/email-lister/master/logo.png',
    links: [
      {
        name: 'GitHub',
  ...
  ventures: [
    {
      ...
      description:
        'Empowering Women Tailors through Outsourced Diversification of Mask Manufacturing',
    ...
    },
    {
      ...
      description:
        'Providing Affordable Buzzer Systems on Rent to Facilitate Competitive Quizzes',
      website: '#',
      status: 'Terminated',
    },
    {
...
const wakatime =
  'https://wakatime.com/share/@29aea669-cbee-443c-8bd3-2fc3f761f79c/a7bb28b7-f3ab-4bae-807d-ff9be0b7e5be.png';
  ...
  sections: [
    {
      ...
      link: '',
      iframe:
        'https://docs.google.com/presentation/d/e/2PACX-1vTX5NLSHDE-qXtwD8EPtA9cHF6DWiqLkm2-thBGlpeWdPc9MgPBw_VS15urn8k99g/embed?start=true&loop=false&delayms=3000',
    },
    {
      title: 'Skills 🚀',
      id: 'skills',
