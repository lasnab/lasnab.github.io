...
function NavBar() {
    ...
    return (
        <div className='fixed w-100 pa2 pt3-ns pb-2-ns ph5-ns top-0 bg-near-black' style={{zIndex:'9999'}}>
            <div className='db dt-ns mw9 white center'>
                ...
                <div className='db dtc-ns v-mid w-100 tl tr-ns mt2 mt0-ns'>
                    { 
                        links.map((link) => {
                            return (<Link to={link.link_path} className='f5 f4-ns fw6 hover-blue link white mr2 mr3-m mr4-l dib'>{ link.link_name }</Link>)
                        })
                    }
                </div>
            </div>
